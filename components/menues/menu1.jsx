...
const Menu1 = (props) => {
    ...
    return (
        <>
            ...
            /> */}
            <nav ref={navRef} className={`w-full  fixed z-30 px-4 sm:px-12 xl:px-12  xl:py-4  ${props.colspan}`}>
                {/* BG */}
                <div className=" z-30 grid container 2xl:mx-auto 2xl:px-8 relative grid-cols-12 m-auto items-center  py-3 sm:py-4 lg:px-0 lg:py-0">
                    {/* Background Image */}
                    ...
                    <div className="col-span-7 md:col-span-9 ">
                        <ul className="hidden font-barlow lg:flex items-center list-style-none justify-start pl-24">
                            {props.menuItems.map((e, i) => {
                                return (
                                    <motion.li
                                        ...
                                        animate="rest"
                                        key={`menuKey${i}`}
                                        className={`relative mx-8 py-4 font-pantonbold tracking-widest font-semibold 
                                       
                                         ${
                                             isScrolled ? "text-secondaryColor-50" : "text-white"
                                    ...
                                    >
                                        <Link
                                            className="flex items-end uppercase text-base lg:text-xs xl:text-lg"
                                            href={`/${e.slug}`}
                                        >
                                            {e.title}{" "}
                                            {e.subMenu ? (
                ...
                <motion.div
                    ref={ref}
                    className="absolute hidden w-full h-full top-0 left-0 bg-secondaryColor-500"
                ></motion.div>
            </nav>
        </>
    );
