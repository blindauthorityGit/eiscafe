...
const Menu2 = (props) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (window.scrollY > navRef2.current.offsetTop) {
                navRef2.current.classList.add("fixed", "top-0");
                ref2.current.classList.remove("hidden", "scale-out-ver-top");
                ref2.current.classList.add("scale-up-ver-top", "block");
                setIsScrolled(true);
            } else {
                // navRef.current.classList.remove("fixed");
                ref2.current.classList.remove("scale-up-ver-top", "block");
                ref2.current.classList.add("scale-out-ver-top");
                setIsScrolled(false);
            }
        };
    ...
    return (
        <>
            ...
            /> */}
            <nav ref={navRef2} className={`w-full fixed z-30 px-4 sm:px-12 lg:py-4  ${props.colspan}`}>
                {/* BG */}
                    ...
                    <div className="logo col-span-4 md:col-span-2 ">
                        <Link href="/">
                            <a className="flex">
                                <img
                                    src={props.logoDark}
                                    className="max-h-[1.75rem] sm:max-h-[3.75rem] fill-current-[#fff]"
                                    alt="Logo"
                                />
                            </a>
                        </Link>
